...
urlpatterns = [
    path('register/', views.register, name='room-register'),
    path('profile/', views.profile, name='profile'),
    path('login/', auth_views.LoginView.as_view(template_name = 'customer/login.html', redirect_authenticated_user = True), name = 'login'),
